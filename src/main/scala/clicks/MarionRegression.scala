...
// LE NOUVEAU FICHIER (A LA SORTIE DE DATACLEANER)
...
val stringIndexers = Array(appOrSiteIndexer, interestsIndexer, mediaIndexer, publisherIndexer, sizeIndexer, timestampIndexer, userIndexer)
...
//val labelStringIndexer = new StringIndexer().setInputCol("label").setOutputCol("label")
